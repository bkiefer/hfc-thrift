...
class HfcDbService_shutdown_args {
 public:

  HfcDbService_shutdown_args(const HfcDbService_shutdown_args&) noexcept;
  HfcDbService_shutdown_args& operator=(const HfcDbService_shutdown_args&) noexcept;
  HfcDbService_shutdown_args() noexcept;

  virtual ~HfcDbService_shutdown_args() noexcept;

  bool operator == (const HfcDbService_shutdown_args & /* rhs */) const;
  bool operator != (const HfcDbService_shutdown_args &rhs) const {
    return !(*this == rhs);
  }

  bool operator < (const HfcDbService_shutdown_args & ) const;
...
class HfcDbService_shutdown_pargs {
 public:


  virtual ~HfcDbService_shutdown_pargs() noexcept;
...
class HfcDbService_shutdown_result {
 public:

  HfcDbService_shutdown_result(const HfcDbService_shutdown_result&) noexcept;
  HfcDbService_shutdown_result& operator=(const HfcDbService_shutdown_result&) noexcept;
  HfcDbService_shutdown_result() noexcept;

  virtual ~HfcDbService_shutdown_result() noexcept;

  bool operator == (const HfcDbService_shutdown_result & /* rhs */) const;
  bool operator != (const HfcDbService_shutdown_result &rhs) const {
    return !(*this == rhs);
  }

  bool operator < (const HfcDbService_shutdown_result & ) const;
...
class HfcDbService_shutdown_presult {
 public:


  virtual ~HfcDbService_shutdown_presult() noexcept;
...
class HfcDbServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  HfcDbServiceProcessor(::std::shared_ptr<HfcDbServiceIf> iface) :
    ...
    processMap_["shutdown"] = &HfcDbServiceProcessor::process_shutdown;
