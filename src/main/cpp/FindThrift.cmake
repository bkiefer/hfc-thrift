...
#
#  Use THRIFT_USE_STATIC_LIBS to prefer static libs for THRIFT_LIBRARIES
# Function
...
if(${THRIFT_USE_STATIC_LIBS})
  set(THRIFT_LIB_NAMES libthrift.a libthrift.lib)
else(${THRIFT_USE_STATIC_LIBS})
  set(THRIFT_LIB_NAMES libthrift.dylib libthrift.so libthrift.dll)
